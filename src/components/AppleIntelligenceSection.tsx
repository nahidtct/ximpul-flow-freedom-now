...
export const AppleIntelligenceSection = () => {
  return <section className="bg-background fade-on-scroll py-24 sm:py-20">
      <div className="max-w-3xl mx-auto px-4 text-center flex flex-col items-center">
        <h2 className="apple-gradient-headline text-5xl sm:text-4xl md:text-6xl mb-3" style={{
        lineHeight: 1.09
      }}>
          Carry your freedom.
        </h2>
        ...
        <img src="/lovable-uploads/be7116ca-cede-48e6-be7a-34d9c8ac4362.png" alt="Water falling into cupped hands" className="mt-4 rounded-2xl shadow-xl w-full max-w-2xl object-cover" />
      </div>
    </section>;
};