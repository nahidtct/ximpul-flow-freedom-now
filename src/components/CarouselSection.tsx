...
export const CarouselSection = () => {
  ...
  return <section className="apple-spacing bg-background">
        ...
        <div className="relative">
          ...
          dragFree: true
            ...
            <CarouselContent className="-ml-4">
              {slides.map((slide, index) => <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                  <Card className="relative h-full border-0 bg-muted/20 hover:bg-muted/30 transition-all duration-300 rounded-2xl overflow-hidden">
                    <CardContent className="p-8 h-full flex flex-col">
                      ...
                      <div className="flex justify-center mb-6">
                        <img src="/lovable-uploads/3206014d-8b7b-48fa-be6b-24c9a2af5025.png" alt="Ximpul Flow Water Bottle" className="w-24 h-32 object-contain" />
                      </div>
