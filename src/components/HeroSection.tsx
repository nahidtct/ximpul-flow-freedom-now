...
export const HeroSection = () => {
  return (
    <section className="hero-section h-screen flex flex-col justify-center items-center relative overflow-hidden py-0 mx-0 my-[52px]">
      {/* Background Gradient */}
      ...
      <div className="relative z-10 w-full h-full hidden md:flex">
        <div className="w-full h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 py-0 my-[22px]">
          {/* Product Name */}
