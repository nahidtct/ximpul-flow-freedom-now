  ...
  return <section className="py-16 bg-background fade-on-scroll">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-0">
          ...
          <div className="w-full">
            <img src="/lovable-uploads/ba703431-7720-4eba-9738-1e7bd3d1780e.png" alt="Portable Handle Rope - Durable Woven Nylon For Lasting Strength & Grip" className="w-full h-auto object-contain" />
          </div>
          
          {/* Third Image - Temperature Control */}
          <div className="w-full">
            <img src="/lovable-uploads/829d04af-dcf4-4386-8ea2-1100018700d0.png" alt="Keep Hot/Cold About 20-24 hours - Heat preservation, durable, strong, leak proof, premium quality" className="w-full h-auto object-contain" />
          </div>
        </div>
      </div>
    </section>;
