  ...
  return (
    <section className="apple-spacing bg-background fade-on-scroll">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Responsive grid with BorderTrail effect on cards */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
          {/* Large feature card with BorderTrail */}
          <div className="relative col-span-2 lg:col-span-2">
            <BorderTrail size={88} />
            <div className="bg-muted/30 rounded-2xl md:rounded-3xl p-4 md:p-8 lg:p-12">
          ...
          {/* Small feature card: Two lid options */}
          ...
          {/* Small feature card: BPA-free, leak-proof */}
          <div className="relative">
            <BorderTrail size={64} />
            <div className="bg-muted/30 rounded-2xl md:rounded-3xl p-3 md:p-8 text-center">
              <h3 className="text-sm md:text-xl font-medium text-foreground mb-2 md:mb-4">
          ...
          {/* Small feature card: Keeps hot/cold 24h */}
          <div className="relative">
            <BorderTrail size={64} />
            <div className="bg-muted/30 rounded-2xl md:rounded-3xl p-3 md:p-8 text-center">
              <h3 className="text-sm md:text-xl font-medium text-foreground mb-2 md:mb-4">
          ...
          {/* Small feature card: Safe for school, office, gym, travel */}
          <div className="relative">
            <BorderTrail size={64} />
            <div className="bg-muted/30 rounded-2xl md:rounded-3xl p-3 md:p-8 text-center">
              ...
              {/* Title is hidden for visual spacing consistency */}
