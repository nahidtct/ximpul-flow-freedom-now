  ...
  return <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      ...
      <div className="p-6">
        <RadioGroup value={selectedEdition} onValueChange={onEditionChange} className="space-y-4">
          {editions.map(edition => <div key={edition.value} className={`relative p-4 rounded-lg border cursor-pointer transition-all ${selectedEdition === edition.value ? 'border-gray-900 bg-gray-100' : 'border-gray-200 hover:border-gray-300'}`}>
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-400 mt-1">
                      {edition.name.includes('Base') ? '500ml Ximpul Flow Bottle, Standard Cap and Silicone Sleeve' : '500ml Ximpul Flow Bottle, Standard & Straw Caps, Silicone Sleeve, Cleaning Brushes and Aluminium Hook'}
                    </div>
                  </div>
