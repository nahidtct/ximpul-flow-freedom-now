...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Product Story Section - Apple Intelligence style */}
      <section className="apple-spacing bg-background fade-on-scroll">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-6xl font-light mb-2 flex flex-col items-center justify-center">
            <span className="apple-ai-gradient-text font-bold block">
              Carry your freedom.
            </span>
            <span className="text-4xl md:text-6xl text-black font-bold mt-2 block">
              One refill at a time.
            </span>
          </h2>
          <p className="text-lg mt-6 font-light text-muted-foreground max-w-2xl mx-auto">
